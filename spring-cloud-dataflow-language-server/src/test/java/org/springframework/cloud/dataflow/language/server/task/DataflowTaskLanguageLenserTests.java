...
public class DataflowTaskLanguageLenserTests {
	...
	public void testTaskMultiEnv() {
		...
		assertThat(lenses.get(1).getRange()).isEqualTo(Range.from(3, 0, 3, 12));

		assertThat(lenses.get(2).getCommand().getCommand()).isEqualTo("vscode-spring-cloud-dataflow.tasks.create");
		...
		assertThat(lenses.get(2).getCommand().getArguments().get(1)).isEqualTo("env3");
		assertThat(lenses.get(2).getCommand().getArguments().get(2)).isEqualTo("desc3");
		assertThat(lenses.get(2).getCommand().getArguments().get(3)).isEqualTo("timestamp");
		assertThat(lenses.get(2).getRange()).isEqualTo(Range.from(9, 0, 9, 9));

		assertThat(lenses.get(3).getCommand().getCommand()).isEqualTo("vscode-spring-cloud-dataflow.tasks.destroy");
		assertThat(lenses.get(3).getCommand().getArguments()).hasSize(2);
		...
		assertThat(lenses.get(3).getRange()).isEqualTo(Range.from(9, 0, 9, 9));

		assertThat(lenses.get(4).getCommand().getCommand()).isEqualTo("vscode-spring-cloud-dataflow.tasks.launch");
		...
		assertThat(lenses.get(4).getRange()).isEqualTo(Range.from(9, 0, 9, 9));
	}
}
